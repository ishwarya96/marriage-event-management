                ...
                child: Row(
                  ...
                  children: [
                    SizedBox(
                      height: 30,
                      child: Image.asset(
                          'assets/google-logo-v1-002-3d-model-low-poly-max-obj-3ds-fbx-ma-stl.jpg'),
                    ),
                    Text(
                      'Sign In with Google',
                      style: TextStyle(
